...
| CM | Alt | Lesson | Source / Inspired By | Characters | Library | Notation By |
|:---:|:---:|---|---|---|:---:|---|
| **[A](cm-a.md)** | | 1st Target Points & Choreographed Movements | Original | | Core | Alfred Smith |
| **[B](cm-b.md)** | | The Corner Hits — Shoulders & Hips | Original | | Core | Alfred Smith |
...
| **[X](https://sabercraft.org/series-80-ep-iv-ovv-cms-81-84/)** | 52 | Series 80: Obi-Wan vs Vader | Star Wars Ep 4: A New Hope — SC 38 Reimagined | Obi-Wan, Vader | Extended | Alfred Smith |

**Alt** is the movement's series number, which is how it is referenced in the cover-fight table below.

## Cover Fights: Film & Series
...
| [Star Wars Ep 7: The Force Awakens](https://sabercraft.org/choreography-kvr/) | Kylo, Rey | 21 | 22 | 23 | 24 | | | | Ana Ma Jacome, Julie Failde | Film |
| [Star Wars Ep 1: The Phantom Menace](https://sabercraft.org/cm-k-staff-vs-sabers/) | Obi-Wan, Maul | 31 | 32 | | | | | | Armando Valdivia, Alfred Smith | Film |
| [Star Wars Ep 5: The Empire Strikes Back](https://sabercraft.org/cm-40-series/) | Luke, Vader | | 42 | | | | | | Alfred Smith | Film |
| [Star Wars Ep 4: A New Hope — SC 38 Reimagined](https://sabercraft.org/series-50-ep-iv-ovv/) | Obi-Wan, Vader | 51 | 52 | 53 | 54 | | | | Alfred Smith | Web |
| [Star Wars Ep 3: Revenge of the Sith](https://sabercraft.org/cm-p-dva/) | Anakin, Dooku | 91 | 92 | 93 | | | | | Kristianna Jones | Film |
...
The film, series, character, and performer names in these tables are descriptive references only. They identify which filmed sequence a given choreography interprets. Nothing here claims ownership of, affiliation with, sponsorship by, or endorsement by the rights holders of those works, and all such names and marks remain the property of their respective owners.

What is catalogued here is the notation for each movement — an interpretation worked out, performed, and written down by Saberists. That notation is what the [Licensing](../licensing.md) terms cover.
