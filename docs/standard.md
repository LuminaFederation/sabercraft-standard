...
One school may write a move one way. Another school may write the same move differently. Without a public reference, nobody knows which version is correct.
...
|---|---|
| Public | People can find it and read it |
| Accessible | Students and schools do not need private access to learn it |
| Maintained | Someone is responsible for keeping it updated |
| Versioned | Changes are tracked over time |
| Reviewable | Choreography can be checked for clarity and accuracy |
...
That can create choreography that feels one-directional:

> one person attacks,  
> the other person reacts,  
> then the next attack happens.

That can be useful for drills, but staged combat needs more.
